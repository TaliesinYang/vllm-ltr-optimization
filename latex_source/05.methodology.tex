...
policy arm subclasses the engine's \texttt{AsyncScheduler} and re-sorts only
the waiting queue before each step, all else stock code; the stock arm runs
the default synchronous scheduler, a difference E5's attribution control
measures.
