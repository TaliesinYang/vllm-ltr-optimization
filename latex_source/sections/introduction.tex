...
% [作者手写区] 要点: 说明长度预测跨域失效风险；区分聊天域旧证据与 Qwen3.5-9B 工具域新证据，禁止跨环境直接比大小。可用数据点: 旧聊天 predictor tau 0.559 -> 0.315；新 prompt+schema BERT test tau-b=0.642329。Bib keys: pars2025, tie2026, egtp2026.
