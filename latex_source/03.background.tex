...
\begin{figure*}[t]
  ...
  \begin{tikzpicture}[x=1mm,y=1mm]
    \begin{scope}[on background layer]
      \node[panel, minimum width=52mm, minimum height=42mm] (client) at (26,0) {};
      \node[panel, minimum width=52mm, minimum height=42mm] (gw)     at (88,0) {};
      \node[panel, minimum width=52mm, minimum height=42mm] (engine) at (150,0) {};
      \node[panel accent, minimum width=52mm, minimum height=42mm] (dec) at (88,-52) {};
      \node[panel, minimum width=52mm, minimum height=42mm] (verd) at (150,-52) {};
    \end{scope}

    % ---- header strips: one language, one height, one baseline per row ------
    \node[tier title, anchor=north west] at (3,18)    {Agent client};
    \node[tier title, anchor=north west] at (65,18)   {Gateway};
    \node[tier title, anchor=north west] at (127,18)  {vLLM engine};
    \node[tier title, anchor=north west] at (65,-34)  {Decision service};
    \node[tier title, anchor=north west] at (127,-34) {Verdict};
    ...
    \node[environment component, inner sep=0pt, minimum width=46mm,
          minimum height=9mm] (cli) at (26,4.5) {OpenCode};
    \node[environment component, align=center, text width=42mm, inner sep=0pt,
          minimum width=46mm, minimum height=9mm] (turn) at (26,-13.5)
      {Captured turn\\{\sub{170 tools, 147\,kB}}};
    \draw[data flow, edge gap] (26,0) -- (26,-9);

    % ---- row 1, col 2: gateway (one flush strip, then the scoring hook) ------
    \node[environment component, inner sep=0pt, minimum width=46mm,
          minimum height=9mm] (strip) at (88,4.5) {};
    \draw[draw=black!45, line width=.7pt] (80.333,0) -- (80.333,9);
    \draw[draw=black!45, line width=.7pt] (95.667,0) -- (95.667,9);
    \node at (72.667,4.5) {Admit};
    \node at (88,4.5)     {Cache};
    \node at (103.333,4.5){Route};
    \node[environment component, align=center, text width=42mm, inner sep=0pt,
          minimum width=46mm, minimum height=9mm] (hook) at (88,-13.5)
      {Scheduler hook\\{\sub{verdict due in 15\,ms}}};
    \draw[data flow, edge gap] (88,0) -- (88,-9);
    ...
    \node[proposed component, align=center, text width=42mm, inner sep=0pt,
          minimum width=46mm, minimum height=9mm] (sched) at (150,4.5)
      {Scheduler\\{\sub{reorders trusted slots}}};
    \node[trusted slot, minimum width=10mm, minimum height=9mm] (q1) at (132,-13.5) {};
    \node[pinned slot,  minimum width=10mm, minimum height=9mm] (q2) at (144,-13.5) {};
    \node[trusted slot, minimum width=10mm, minimum height=9mm] (q3) at (156,-13.5) {};
    \node[pinned slot,  minimum width=10mm, minimum height=9mm] (q4) at (168,-13.5) {};
    ...
    \draw[data flow, edge gap]
      (156,-9) .. controls (150,-2) and (138,-2) .. (132,-9);

    % ---- row 2, col 2: decision service, one flush three-lane stack ---------
    \node[proposed component, inner sep=0pt, minimum width=46mm,
          minimum height=27mm] (stack) at (88,-56.5) {};
    \draw[draw=sysaccent!85!black, line width=.9pt] (65,-52) -- (111,-52);
    \draw[draw=sysaccent!85!black, line width=.9pt] (65,-61) -- (111,-61);
    \node at (88,-47.5) {Stratum classifier};
    \node at (88,-56.5) {Reliability Gate};
    \node at (88,-65.5) {Schema-aware Ranker};

    % ---- row 2, col 3: the verdict, as two boxes an arrow can land on -------
    \node[environment component, align=center, text width=42mm, inner sep=0pt,
          minimum width=46mm, minimum height=9mm] (fo) at (150,-47.5)
      {Arrival order\\{\sub{abstain, or 15\,ms passes}}};
    \node[proposed component, align=center, text width=42mm, inner sep=0pt,
          minimum width=46mm, minimum height=9mm] (key) at (150,-65.5)
      {Reorder key\\{\sub{trusted: S3 / S4}}};
    \draw[degraded flow, edge gap, lane turn]
      (111,-56.5) -- (119,-56.5) -- (119,-47.5) -- (127,-47.5);
    \draw[data flow, edge gap] (111,-65.5) -- (127,-65.5);
    ...
    \draw[data flow, edge gap] (75.75,-21) -- (75.75,-31);
    \node[metric badge, anchor=west] at (77.25,-26) {score, 15\,ms};
    \draw[data flow, edge gap] (141.75,-31) -- (141.75,-21);
    \node[metric badge, anchor=west] at (143.25,-26) {verdict};

    % ---- edges on the serving path -----------------------------------------
    \draw[data flow, edge gap, lane turn] (49,-13.5) -- (57,-13.5) -- (57,4.5) -- (65,4.5);
    \draw[data flow, edge gap] (111,4.5) -- (127,4.5);
    ...
    \node[proposed component, inner sep=0pt, minimum width=7mm,
          minimum height=4.4mm] at (8.5,-47) {};
    \node[fact label, fill=none, anchor=west, text=black!75] at (13.5,-47)
      {added by this work};
    \node[environment component, inner sep=0pt, minimum width=7mm,
          minimum height=4.4mm] at (8.5,-52) {};
    \node[fact label, fill=none, anchor=west, text=black!75] at (13.5,-52)
      {unchanged substrate};
    \draw[degraded flow] (5,-57) -- (12,-57);
    \node[fact label, fill=none, anchor=west, text=black!75] at (13.5,-57)
      {fail-open path};
  \end{tikzpicture}
