...
3.96\,requests/s and nineteen at 6.4, under a fourteenth of that cap. Mean
occupancy does not forbid queueing, and our logs show it did not: bursts put
12.4\% of requests behind another, but those queues drained within a
...
\subsection{Future Work (Six Months)}
First, add an oracle-order arm sorting by measured length, separating
